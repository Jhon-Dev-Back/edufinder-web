...
public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    ...
    boolean validarRutaLogin = (rutaSolicitud.equals(raiz + "/") || (rutaSolicitud.equals(raiz + "/index.xhtml")) ||rutaSolicitud.equals(raiz + "/registro.xhtml") ||rutaSolicitud.equals(raiz + "/inicioSesion.xhtml") || rutaSolicitud.equals("/registro.xhtml" + "/index.xhtml") || rutaSolicitud.equals("/index.xhtml" + "/inicioSesion.xhtml"));
